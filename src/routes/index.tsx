      ...
      <section id="top" className="relative min-h-[100svh] overflow-hidden bg-[var(--espresso)] text-[var(--cream)]">
        ...
        <div className="relative mx-auto flex min-h-[100svh] max-w-7xl flex-col justify-end px-6 pb-20 pt-32 lg:px-12">
          <div className="max-w-2xl">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[var(--cream)]/20 bg-[var(--cream)]/5 px-3 py-1 text-xs uppercase tracking-[0.2em] backdrop-blur">
              <span className="h-1.5 w-1.5 rounded-full bg-[var(--cream)]" /> Одеса · Молдаванка
            </div>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              <a
                href="#menu"
                className="group inline-flex items-center gap-3 rounded-full bg-[var(--cream)] px-7 py-4 text-sm font-semibold text-[var(--espresso)] transition hover:bg-white"
              >
                Посмотреть меню
          ...
          <div className="mt-16 flex flex-wrap items-end justify-between gap-6 border-t border-[var(--cream)]/15 pt-8">
            <div>
              <div className="font-display text-4xl">5.0 <span className="text-2xl">★</span></div>
              <div className="mt-1 text-xs uppercase tracking-widest text-[var(--cream)]/60">23 отзыва Google</div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="grid gap-12 lg:grid-cols-[1fr_2fr] lg:gap-20">
            <div>
              ...
              <div className="mt-10 rounded-2xl bg-[var(--espresso)] p-8 text-[var(--cream)]">
                <div className="font-display text-7xl font-semibold">5.0</div>
                <div className="mt-2 text-lg tracking-wide">★ ★ ★ ★ ★</div>
                <div className="mt-4 text-sm text-[var(--cream)]/70">
                  Средняя оценка по 23 проверенным отзывам в Google.
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              {reviews.map((r, i) => (
                <figure
                  key={i}
                  className={`rounded-2xl border border-border bg-card p-7 ${i === 0 ? "sm:row-span-2 sm:flex sm:flex-col sm:justify-between" : ""}`}
                >
      ...
      <section id="about" className="bg-[var(--sand)] py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          ...
          <div className="mt-16 grid gap-px overflow-hidden rounded-3xl bg-border md:grid-cols-3">
            {features.map((f) => (
              <div key={f.title} className="bg-[var(--sand)] p-10">
                <div className="font-display text-5xl text-[var(--roast)]">{f.icon}</div>
      ...
      <section id="visit" className="bg-[var(--espresso)] py-24 text-[var(--cream)] lg:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-20">
                ...
                <div className="sm:col-span-2">
                  ...
                  <dd className="mt-3 grid grid-cols-7 gap-2">
                    {schedule.map((d) => (
                      <div
                        key={d}
                        className="rounded-lg border border-[var(--cream)]/15 px-2 py-3 text-center"
                      >
            ...
            <div className="relative min-h-[400px] overflow-hidden rounded-3xl border border-[var(--cream)]/10">
              <iframe
              ...
              />
              <div className="pointer-events-none absolute bottom-4 left-4 rounded-full bg-[var(--espresso)] px-4 py-2 text-xs font-medium text-[var(--cream)] shadow-lg">
                ★ Hate Coffee · 5.0
              </div>
            </div>
          </div>
