...
const menu = [
  { name: "Эспрессо", desc: "Классический двойной шот, насыщенный и плотный", price: "45 ₴", img: menuCoffee },
  { name: "Латте", desc: "Двойной эспрессо, бархатное паровое молоко", price: "65 ₴", img: menuLatte },
...
const marqueeWords = [
  ...
  "Вкуснейшее кофе <3", "★", "Хот-доги", "★", "Приморский район", "★", "07:00 — 21:30", "★",
];
